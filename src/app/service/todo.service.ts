...
savePhone(data){
  return this.http2.post<contactData>(this.local+'/api/dataAdjust.php',{ac:"savePhone",data:data});
}

checkOTP(tel,otp){
  return this.http2.post<contactData>(this.local+'/api/dataAdjust.php',{ac:"checkOTP",data:tel,otp:otp});
}
