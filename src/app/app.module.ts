...
import { barcaraComponent } from './components/barcara/barcara.component';
//import { NgbModule } from '@ng-bootstrap/ng-bootstrap';
const appRoutes:Routes = [
  
  {path:"home", component:HomeComponent, canActivate:[AuthGuard]},
  {path:"home/:id", component:HomeComponent, canActivate:[AuthGuard]},
  {path:"home/page/:id", component:HomeComponent, canActivate:[AuthGuard]},
  {path:"affm", 
  ...
  {path:"barcara", component:barcaraComponent, canActivate:[AuthGuard]},
